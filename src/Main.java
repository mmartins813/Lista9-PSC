public class Main {
    public static void main(String[] args) {
        ...
        String desejo = "Poder de dormir infinitamente a vontade sem estresse";
        String desejoEmNamekusei = dende.fazerDesejo(desejo);
        System.out.println("Desejo em Namekusei: " + desejoEmNamekusei);

        desejo = "Força do Dragão";
        desejoEmNamekusei = dende.fazerDesejo(desejo);
        System.out.println("Desejo em Namekusei: " + desejoEmNamekusei);

        desejo = "Canhão de Fogo";
        desejoEmNamekusei = dende.fazerDesejo(desejo);
        System.out.println("Desejo em Namekusei: " + desejoEmNamekusei);
    }
}
